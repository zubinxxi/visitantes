...
if(!empty({vs})){
    ...
    ?>
    <style>
    /* Configuración para 4x2" (101.6mm x 57.15mm) */
    .ticket-wrapper { width: 100%; font-family: Arial, sans-serif; padding: 0; margin: 0; }

    .header-section { width: 100%; text-align: center; padding-bottom: 1mm; margin-bottom: 1mm; }
    .text-h1 { font-size: 12pt; font-weight: bold; }
    .text-cedula { font-size: 9pt; font-weight: bold; }

    .table-body { width: 100%; border-collapse: collapse; border-style: none; margin-left: auto; margin-right: auto; }
    .table-body-visit { width: 8%; background-color: #000; color: #fff; vertical-align: middle; text-align: center; border-radius: 10px; }
    .table-body-visit span { text-align: center; font-weight: bold; font-size: 20px; }
    .table-body-txt { width: 92%; padding-left: 10px;}

    /* Unidades visitadas */
    .section-title { font-size: 7.5pt; font-weight: bold; background-color: #eee; border-bottom: 0.4px solid #000; padding: 1px 2px; }
    .uadm-text { font-size: 7pt; line-height: 1.1; margin-top: 1mm; font-weight: bold;}

    /* SECCIÓN INFERIOR: QR/Logo Izquierda y Edificios Derecha */
    .bottom-table { width: 100%; border-collapse: collapse; margin-top: 1.7mm; }
    .col-qr-brand { width: 40mm; vertical-align: middle; text-align: left; }
    ...
    <page backtop="1mm" backbottom="1mm" backleft="2mm" backright="2mm">
    <div class="ticket-wrapper">

    <table class="table-body">
    <tr>
    <td class="table-body-visit">
    <span>V</span><br>
    <span>I</span><br>
    <span>S</span><br>
    <span>I</span><br>
    ...
    <td class="table-body-txt">
    <div class="header-section">
    <span class="text-h1"><?php echo mb_strtoupper($nombre_visitor); ?></span><br>
    <span class="text-cedula">CED: <?php echo $id_card_number; ?> | <?php echo $check_in; ?></span>
    </div>
    ...
    <table style="height: 10px; width: 100%; border-collapse: collapse; border-style: none; margin-left: auto; margin-right: auto; margin-top: 5px;" cellpadding="10">
    <tbody>
    <tr style="height: 10px;">
    <td style="width: 20%; height: 10px; vertical-align: middle;">
    <qrcode value="<?php echo $id_visita; ?>" ec="L" style="width: 16mm;"></qrcode>
    </td>
    <td style="width: 60%; height: 10px; vertical-align: middle;">
    ...
    <td style="width: 20%; height: 10px; text-align: center; vertical-align: middle;">
    ...
    $html2pdf = new Spipu\Html2Pdf\Html2Pdf('L', array(101, 57), 'es', true, 'UTF-8', array(0, 0, 0, 0));
