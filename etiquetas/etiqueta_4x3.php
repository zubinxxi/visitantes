...
if(!empty({vs})){
    ...
    ?>
    <style>
        /* Configuración para 4x3" (101.6mm x 76.2mm) */
        .ticket-wrapper { width: 100%; height: 70mm; font-family: Arial, sans-serif; padding: 0; margin: 0; position: relative;}

		/* Cabecera */
        .header-section { width: 100%; text-align: center; padding-bottom: 1mm; margin-bottom: 1mm; }
        .text-h1 { font-size: 14pt; font-weight: bold; }
        .text-cedula { font-size: 11pt; font-weight: bold; }

        /* Unidades visitadas */
        .section-title { font-size: 9pt; font-weight: bold; background-color: #eee; border-bottom: 1px solid #000; padding: 1px 2px; }
        .uadm-text { font-size: 8pt; line-height: 1.1; margin-top: 1mm; font-weight: bold; }

        /* QR/Logo Izquierda y Edificios Derecha */
        .bottom-table { height: 10px; width: 100%; border-collapse: collapse; border-style: none; margin-left: auto; margin-right: auto; margin-top: 1.5mm; }
        .table-td-qr { width: 20%; height: 10px; vertical-align: middle; }
        .table-td-edificios { width: 60%; height: 10px; vertical-align: middle; }
		.table-td-logo { width: 20%; height: 10px; text-align: center; vertical-align: middle; }
        ...
        .edificios-table th { font-size: 8pt; border: 0.5px solid #000; background-color: #f0f0f0; width: 14.2%; text-align: center; }
        .edificios-table td { height: 18px; border: 0.5px solid #000; text-align: center; }
		...
		.text-visitante { font-size: 35px; font-weight: bold; }
		.footer-fix { position: absolute; bottom: 0; width: 100%; border-top: 0.5px solid #000; }
    </style>

    <page backtop="2mm" backbottom="0mm" backleft="4mm" backright="1mm">
    ...
    $html2pdf = new Spipu\Html2Pdf\Html2Pdf('L', array(106, 76), 'es', true, 'UTF-8', array(0, 0, 0, 0));
