...
if(!empty({vs})){
    ...
    ?>
    <style>
        /* Configuración para 3x4" (76.2mm x 101.6mm) */
        .ticket-wrapper { width: 100%; height: 98mm; font-family: Arial, sans-serif; padding: 0; margin: 0; position: relative;}

		/* Cabecera */
        .header-section { width: 100%; text-align: center; padding-bottom: 1mm; margin-bottom: 1mm; margin-top: 1.5mm;}
        .text-h1 { font-size: 14pt; font-weight: bold; text-align: center;}
        ...
        .uadm-text { font-size: 8pt; line-height: 1.1; margin-top: 1mm; margin-bottom:1.5mm; font-weight: bold; }

        /* QR/Logo */
        .table-qr-logo {height: 10px; width: 100%; border-collapse: collapse; border-style: none; margin-left: auto; margin-right: auto; margin-top: 1.5mm;}
        .table-col-qr { width: 50%; height: 10px; vertical-align: middle; }
        .table-col-logo { width: 50%; height: 10px; text-align: right; vertical-align: middle; }
		.logo-amp-small { width: 14mm; margin-top: 1mm; }


        /* Tabla de Edificios: Ahora ocupa el 100% de su columna */
        .edificios-table { width: 100%; margin: 0 auto; border: 1px solid #000; margin-top: 5px; }
		...
		.text-visitante { font-size: 30px; font-weight: bold; }
    ...
    <page backtop="2mm" backbottom="0mm" backleft="4mm" backright="1mm">
        ...
        <div class="ticket-wrapper">
			...
			<table class="table-qr-logo">
				<tbody>
					<tr>
						<td class="table-col-qr">
    ...
    $html2pdf = new Spipu\Html2Pdf\Html2Pdf('P', array(76, 106), 'es', true, 'UTF-8', array(0, 0, 0, 0));
