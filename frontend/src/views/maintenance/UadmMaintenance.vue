...
const columns: CrudColumn[] = [
  ...
  { key: 'province_name', label: 'Provincia', type: 'text' },
  { key: 'institution_name', label: 'Institución', type: 'text' },
  { key: 'type_uadm_name', label: 'Tipo UADM', type: 'text' },
...
} = useCrud('/maintenance/uadms', columns, 'Unidades Administrativas')
